...
const Home = () => {
  ...
  return (
    <div className="home-container">
      ...
      <p className="home-subtitlelines">Prepare for your dream placement with our comprehensive assessment platform featuring MCQ tests, coding challenges, and personalized AI feedback.</p>
