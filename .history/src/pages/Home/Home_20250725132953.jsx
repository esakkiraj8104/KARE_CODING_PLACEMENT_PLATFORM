...
const Home = () => {
  ...
  <button className="btn same-size">Student Login</button>
  <button className="btn same-size">Admin Login</button>
</div>
        ...
        <section className="features-section">
          <h3 className="features-title">Why Use KARE ASSESSMENT & CODING  PLATFORM ?</h3>
